...
function DocumentHeader() {
  return (
    <div className="flex items-center justify-between mb-4 p-4 border-b print:border-b print:mb-4 print:p-0">
      <Image src="/images/santiago.jpg" alt="Barangay Santiago" width={60} height={60} className="w-12 h-12 md:w-16 md:h-16 rounded-full object-cover shrink-0 print:w-14 print:h-14" />
      <div className="text-center flex-1 px-2">
        <p className="text-[10px] md:text-xs text-muted-foreground print:text-black print:text-xs">Republic of the Philippines</p>
        <p className="text-xs md:text-sm font-semibold print:text-black print:text-sm">BARANGAY SANTIAGO</p>
        <p className="text-[10px] md:text-xs text-muted-foreground print:text-black print:text-xs">City of Santiago, Isabela</p>
      </div>
      <Image src="/images/saz.jpg" alt="City of Santiago" width={60} height={60} className="w-12 h-12 md:w-16 md:h-16 rounded-full object-cover shrink-0 print:w-14 print:h-14" />
    </div>
  )
}
        ...
        {selectedRequest && (
          <div className="print:p-0">
            ...
            <div className="flex items-center justify-between mb-6 pb-4 border-b-2 border-black">
              <Image src="/images/santiago.jpg" alt="Santiago" width={56} height={56} className="w-14 h-14 rounded-full object-cover" />
              <div className="text-center flex-1 px-4">
                ...
                <p className="text-xs font-bold">BARANGAY SANTIAGO</p>
                <p className="text-xs mt-2">OFFICE OF THE BARANGAY CAPTAIN</p>
                <p className="text-sm font-bold mt-3 uppercase">{selectedRequest.type}</p>
              </div>
              <Image src="/images/saz.jpg" alt="City" width={56} height={56} className="w-14 h-14 rounded-full object-cover" />
            </div>
